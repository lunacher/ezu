...
from courseinfo.views import (
    InstructorList, SectionList, SemesterList, StudentList, CourseList,
    RegistrationList, InstructorDetail, RegistrationDetail, CourseDetail,
    StudentDetail, SemesterDetail, SectionDetail, InstructorCreate,
    CourseCreate, SemesterCreate, SectionCreate, StudentCreate, RegistrationCreate,
    InstructorUpdate, CourseUpdate, SemesterUpdate, SectionUpdate,
    StudentUpdate, RegistrationUpdate, InstructorDelete, CourseDelete,
    SemesterDelete, SectionDelete, StudentDelete, RegistrationDelete,
